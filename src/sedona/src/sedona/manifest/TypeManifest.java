...
//////////////////////////////////////////////////////////////////////////
  ...
  public TypeManifest(KitManifest kit, int id, String name, Facets facets, String base, int sizeof)
  {
    this.kit    = kit;
    this.id     = id;
    this.name   = name;
...
//////////////////////////////////////////////////////////////////////////
  ...
  public static TypeManifest decodeXml(KitManifest kit, XElem xml)
  {
    ...
    TypeManifest t = new TypeManifest(kit, id, name, facets, base, size);
