 ...
 *
 */
public class DaspMessage implements DaspConst
{
////////////////////////////////////////////////////////////////
// Static Factories
////////////////////////////////////////////////////////////////
   ...
   * @see #decode(byte[], int)
   */
  public static DaspMessage decode(DatagramPacket p)
    throws UnsupportedEncodingException
  {
   ...
   *           if a Str header in the message is not properly encoded.
   */
  public static DaspMessage decode(byte[] buf, final int length) 
    throws UnsupportedEncodingException
  {
    
    return new DaspMessage(buf, length);
  }
...
////////////////////////////////////////////////////////////////
   ...
   *           if a Str header in the message is not properly encoded.
   */
  protected DaspMessage(byte[] buf, final int length) throws UnsupportedEncodingException
  {
